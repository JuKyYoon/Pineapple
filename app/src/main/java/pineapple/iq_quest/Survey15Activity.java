/**
 * 2016-12-20
 * 15th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
public class Survey15Activity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        setContentView(R.layout.activity_survey15);
...
//        startActivity(intent);
        ...
        finish();
        CheckBox answer_15_1 = (CheckBox) findViewById(R.id.answer_15_1);
        //option1.isChecked() 는 리턴값이 불

        if(answer_15_1.isChecked()){
            LoginActivity.one.setOk(1);
        }
        else{
            LoginActivity.one.setNo(1);
        }
        startActivity(new Intent(Survey15Activity.this,Survey16Activity.class));
