/**
 * 2016-12-20
 * 12th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
/**
 * The type Survey 12 activity.
 */
public class Survey12Activity extends Activity{
...
//        startActivity(intent);
        ...
        finish();
        CheckBox answer_12_3 = (CheckBox) findViewById(R.id.answer_12_3);
        //option1.isChecked() 는 리턴값이 불

        if(answer_12_3.isChecked()){
            LoginActivity.one.setOk(1);
        }
        else{
            LoginActivity.one.setNo(1);
        }
        startActivity(new Intent(Survey12Activity.this,Survey13Activity.class));
