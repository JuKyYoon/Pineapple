/**
 * 2016-12-20
 * 18th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
/**
 * The type Survey 18 activity.
 */
public class Survey18Activity extends Activity{
    Chronometer chron;  // Chronometer declaration to measure time.

    @Override
    public void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_survey18);
...
//        startActivity(intent);
        ...
        finish();
        CheckBox answer_18_2 = (CheckBox) findViewById(R.id.answer_18_2);
        //option1.isChecked() 는 리턴값이 불

        if(answer_18_2.isChecked()){
            LoginActivity.one.setOk(1);
        }
        else{
            LoginActivity.one.setNo(1);
        }
        startActivity(new Intent(Survey18Activity.this,Survey19Activity.class));
