/**
 * 2016-12-20
 * 16th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
public class Survey16Activity extends Activity{
    Chronometer chron;
...
//        startActivity(intent);
        ...
        finish();
        CheckBox answer_16_4 = (CheckBox) findViewById(R.id.answer_16_4);
        //option1.isChecked() 는 리턴값이 불

        if(answer_16_4.isChecked()){
            LoginActivity.one.setOk(1);
        }
        else{
            LoginActivity.one.setNo(1);
        }
        startActivity(new Intent(Survey16Activity.this,Survey17Activity.class));
