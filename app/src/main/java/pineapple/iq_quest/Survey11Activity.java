/**
 * 2016-12-20
 * 11th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
/**
 * The type Survey 11 activity.
 */
public class Survey11Activity extends Activity{
...
//        startActivity(intent);
        ...
        finish();
        CheckBox answer_11_4 = (CheckBox) findViewById(R.id.answer_11_4);
        //option1.isChecked() 는 리턴값이 불

        if(answer_11_4.isChecked()){
            LoginActivity.one.setOk(1);
        }
        else{
            LoginActivity.one.setNo(1);
        }
        startActivity(new Intent(Survey11Activity.this,Survey12Activity.class));
