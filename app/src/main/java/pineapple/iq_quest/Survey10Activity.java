/**
 * 2016-12-20
 * 10th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
/**
 * The type Survey 10 activity.
 */
public class Survey10Activity extends Activity{
...
//        startActivity(intent);
        ...
        finish();
        CheckBox answer_10_2 = (CheckBox) findViewById(R.id.answer_10_2);
        //option1.isChecked() 는 리턴값이 불

        if(answer_10_2.isChecked()){
            LoginActivity.one.setOk(1);
        }
        else{
            LoginActivity.one.setNo(1);
        }
        startActivity(new Intent(Survey10Activity.this,Survey11Activity.class));
