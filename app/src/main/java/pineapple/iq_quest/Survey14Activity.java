/**
 * 2016-12-20
 * 14th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
/**
 * The type Survey 14 activity.
 */
public class Survey14Activity extends Activity{
    Chronometer chron;  // Chronometer declaration to measure time.

    @Override
    public void onCreate(Bundle savedInstanceState){
        super.onCreate(savedInstanceState);
        setContentView(R.layout.activity_survey14);
...
//        startActivity(intent);
        ...
        finish();
        CheckBox answer_14_3 = (CheckBox) findViewById(R.id.answer_14_3);
        //option1.isChecked() 는 리턴값이 불

        if(answer_14_3.isChecked()){
            LoginActivity.one.setOk(1);
        }
        else{
            LoginActivity.one.setNo(1);
        }
        startActivity(new Intent(Survey14Activity.this,Survey15Activity.class));
