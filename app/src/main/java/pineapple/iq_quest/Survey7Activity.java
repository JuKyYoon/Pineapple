/**
 * 2016-12-20
 * 7th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
/**
 * The type Survey 7 activity.
 */
public class Survey7Activity extends Activity{
...
//        startActivity(intent);
        ...
        finish();
        CheckBox answer_7_2 = (CheckBox) findViewById(R.id.answer_7_2);
        //option1.isChecked() 는 리턴값이 불

        if(answer_7_2.isChecked()){
            LoginActivity.one.setOk(1);
        }
        else{
            LoginActivity.one.setNo(1);
        }
        startActivity(new Intent(Survey7Activity.this,Survey8Activity.class));
