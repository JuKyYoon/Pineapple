/**
 * 2016-12-20
 * 8th survey activity in the application
 * @author Pineapple
 * @version 1.0
 */
...
/**
 * The type Survey 8 activity.
 */
public class Survey8Activity extends Activity{
    ...
    public void onCreate(Bundle savedInstanceState){
        ...
        chron = (Chronometer) findViewById(R.id.chron); //Set the chronometer time.
